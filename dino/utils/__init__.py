...
def join_the_room(user_id: str, user_name: str, room_id: str, room_name: str, session_id: str, is_sid_room=False) -> None:
    # we don't create the db representation of the sid rooms
    if not is_sid_room:
        environ.env.db.join_room(user_id, user_name, room_id, room_name, session_id)
